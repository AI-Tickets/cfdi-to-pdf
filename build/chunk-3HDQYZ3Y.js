...
var AbstractPdfMakerBuilder = class {
  ...
  async defaultCatalogs() {
    ...
    const { default: nominaTiposNominasRaw } = await import("@nodecfdi/sat-micro-catalogs/raw/nomina_tipos_nominas", { assert: { type: "json" } });
    const { default: nominaTiposPercepcionesRaw } = await import("@nodecfdi/sat-micro-catalogs/raw/nomina_tipos_percepciones", { assert: { type: "json" } });
    const { default: nominaTiposOtrosPagosRaw } = await import("@nodecfdi/sat-micro-catalogs/raw/nomina_tipos_otros_pagos", { assert: { type: "json" } });
    const { default: nominaTiposContratosRaw } = await import("@nodecfdi/sat-micro-catalogs/raw/nomina_tipos_contratos", { assert: { type: "json" } });
    const { default: nominaTiposJornadasRaw } = await import("@nodecfdi/sat-micro-catalogs/raw/nomina_tipos_jornadas", { assert: { type: "json" } });
    const { default: nominaTiposRegimenesRaw } = await import("@nodecfdi/sat-micro-catalogs/raw/nomina_tipos_regimenes", { assert: { type: "json" } });
    const { default: nominaPeriodicidadesPagosRaw } = await import("@nodecfdi/sat-micro-catalogs/raw/nomina_periodicidades_pagos", { assert: { type: "json" } });
    const { default: nominaRiesgosPuestosRaw } = await import("@nodecfdi/sat-micro-catalogs/raw/nomina_riesgos_puestos", { assert: { type: "json" } });
    const { default: nominaEstadosRaw } = await import("@nodecfdi/sat-micro-catalogs/raw/nomina_estados", { assert: { type: "json" } });
    return {
      ...
      nominaEstados: wrapCatalog(nominaEstadosRaw.map((e) => ({ id: e.estado, texto: e.texto })))
    };
  }
  layouts() {
